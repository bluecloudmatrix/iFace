...
var threeDHeight = 80;
var mapMatrix;
mapMatrix = new Array(80);
for (var i = 0; i < 80; i++) {
	mapMatrix[i] = new Array(125);
	for(var j = 0; j < 125; j++) {
...
function to3DRTC() {
	...
	function startWebRtc(){
		...
		channel.onmessage = function(obj, userid) {
			...
			*/	
			if(strMap.length >=9999 && receiveMap == 0){
				//alert(strMap);
				//$('#InitBlocks').fadeIn();
				//alert(obj.eye);
				for (var i = 0; i < 80; i++) {
					for(var j = 0; j < 125; j++) {
						mapMatrix[i][j] = strMap.charAt(i*125+j); //ground
					}
				}				
				if(obj.eye == 1){
					var d=document.getElementById('st');
					d.style.background = '#ddf5f7';
					InitLight_open();
					InitFloor_open();
					InitBlocks_open();
				}else{
				...
				if(obj.mouth == 0) { //happy
					var music = document.getElementById("bgSound_00");
					music.play();
				} else if(obj.mouth == 1){ //nature
	...
	*/
	...
	function moveBall(event) {
		...
		if(accel_x > 0.5) { //right
			keyArr[65] = 0;	
			keyArr[68] = 1;
		} else if(accel_x < -0.5) { //left
			keyArr[68] = 0;
			keyArr[65] = 1;			
		} else {
			keyArr[68] = 0;
...
function pressCover11(){
	var elem = document.getElementById('cover11');
	if(currentJigsaw == 1){		
		elem.style.display = 'none';
		document.jigCov12.src="jigsaw/cover.png";
		document.jigCov21.src="jigsaw/cover.png";
		document.jigCov22.src="jigsaw/cover.png";
		var elem2 = document.getElementById('jigsaw11');
		elem2.style.display = 'none';
		//missingPiece--;
		clickJigsaw = 1;
	}else{
		document.jigCov11.src="jigsaw/cover2.png";
	}
}
function pressCover12(){
	var elem = document.getElementById('cover12');
	if(currentJigsaw == 2){		
		elem.style.display = 'none';
		document.jigCov11.src="jigsaw/cover.png";
		document.jigCov21.src="jigsaw/cover.png";
		document.jigCov22.src="jigsaw/cover.png";
		var elem2 = document.getElementById('jigsaw12');
		elem2.style.display = 'none';
		//missingPiece--;
		clickJigsaw = 2;
	}else{
		document.jigCov12.src="jigsaw/cover2.png";
	}
}
function pressCover21(){
	var elem = document.getElementById('cover21');
	if(currentJigsaw == 3){		
		elem.style.display = 'none';
		document.jigCov12.src="jigsaw/cover.png";
		document.jigCov11.src="jigsaw/cover.png";
		document.jigCov22.src="jigsaw/cover.png";
		var elem2 = document.getElementById('jigsaw21');
		elem2.style.display = 'none';
		//missingPiece--;
		clickJigsaw = 3;
	}else{
		document.jigCov21.src="jigsaw/cover2.png";
	}
}
function pressCover22(){
	var elem = document.getElementById('cover22');
	if(currentJigsaw == 4){		
		elem.style.display = 'none';
		document.jigCov12.src="jigsaw/cover.png";
		document.jigCov21.src="jigsaw/cover.png";
		document.jigCov11.src="jigsaw/cover.png";
		var elem2 = document.getElementById('jigsaw22');
		elem2.style.display = 'none';
		//missingPiece--;
		clickJigsaw = 4;
	}else{
		document.jigCov22.src="jigsaw/cover2.png";
	}
}
